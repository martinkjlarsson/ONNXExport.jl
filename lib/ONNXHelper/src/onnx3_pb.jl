# Autogenerated using ProtoBuf.jl v1.2.0 on 2025-11-10T17:28:56.033

import ProtoBuf as PB
using ProtoBuf: OneOf
using ProtoBuf.EnumX: @enumx

export Version, DeviceConfigurationProto, var"TensorProto.Segment"
export var"TensorShapeProto.Dimension", StringStringEntryProto, SimpleShardedDimProto
export OperatorStatus, OperatorSetIdProto, var"TensorProto.DataLocation"
export IntIntListEntryProto, var"AttributeProto.AttributeType", var"TensorProto.DataType"
export TensorShapeProto, TensorAnnotation, ShardedDimProto, TensorProto
export var"TypeProto.SparseTensor", var"TypeProto.Tensor", ShardingSpecProto
export SparseTensorProto, NodeDeviceConfigurationProto, NodeProto, TrainingInfoProto
export var"TypeProto.Map", var"TypeProto.Optional", var"TypeProto.Sequence", ValueInfoProto
export AttributeProto, GraphProto, FunctionProto, ModelProto, TypeProto
abstract type var"##Abstract#GraphProto" end
abstract type var"##Abstract#ModelProto" end
abstract type var"##Abstract#AttributeProto" end
abstract type var"##Abstract#NodeProto" end
abstract type var"##Abstract#TypeProto.Sequence" end
abstract type var"##Abstract#TypeProto" end
abstract type var"##Abstract#TypeProto.Optional" end
abstract type var"##Abstract#TypeProto.Map" end
abstract type var"##Abstract#TrainingInfoProto" end
abstract type var"##Abstract#ValueInfoProto" end
abstract type var"##Abstract#FunctionProto" end


@enumx Version _START_VERSION=0 IR_VERSION_2017_10_10=1 IR_VERSION_2017_10_30=2 IR_VERSION_2017_11_3=3 IR_VERSION_2019_1_22=4 IR_VERSION_2019_3_18=5 IR_VERSION_2019_9_19=6 IR_VERSION_2020_5_8=7 IR_VERSION_2021_7_30=8 IR_VERSION_2023_5_5=9 IR_VERSION_2024_3_25=10 IR_VERSION_2025_05_12=11 IR_VERSION=12
...
PB.default_values(::Type{DeviceConfigurationProto}) = (;name = "", num_devices = zero(Int32), device = Vector{String}())
PB.field_numbers(::Type{DeviceConfigurationProto}) = (;name = 1, num_devices = 2, device = 3)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:DeviceConfigurationProto})
    name = ""
    num_devices = zero(Int32)
    device = PB.BufferedVector{String}()
    while !PB.message_done(d)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
            name = PB.decode(d, String)
        elseif field_number == 2
            num_devices = PB.decode(d, Int32)
    ...
    return DeviceConfigurationProto(name, num_devices, device[])
end

function PB.encode(e::PB.AbstractProtoEncoder, x::DeviceConfigurationProto)
    initpos = position(e.io)
    !isempty(x.name) && PB.encode(e, 1, x.name)
    x.num_devices != zero(Int32) && PB.encode(e, 2, x.num_devices)
    !isempty(x.device) && PB.encode(e, 3, x.device)
    return position(e.io) - initpos
end
function PB._encoded_size(x::DeviceConfigurationProto)
    encoded_size = 0
    !isempty(x.name) && (encoded_size += PB._encoded_size(x.name, 1))
    x.num_devices != zero(Int32) && (encoded_size += PB._encoded_size(x.num_devices, 2))
    !isempty(x.device) && (encoded_size += PB._encoded_size(x.device, 3))
    return encoded_size
end
...
struct SimpleShardedDimProto
    dim::Union{Nothing,OneOf{<:Union{Int64,String}}}
    num_shards::Int64
end
PB.oneof_field_types(::Type{SimpleShardedDimProto}) = (;
    dim = (;dim_value=Int64, dim_param=String),
)
PB.default_values(::Type{SimpleShardedDimProto}) = (;dim_value = zero(Int64), dim_param = "", num_shards = zero(Int64))
PB.field_numbers(::Type{SimpleShardedDimProto}) = (;dim_value = 1, dim_param = 2, num_shards = 3)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SimpleShardedDimProto})
    dim = nothing
    num_shards = zero(Int64)
    while !PB.message_done(d)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
            dim = OneOf(:dim_value, PB.decode(d, Int64))
        elseif field_number == 2
            dim = OneOf(:dim_param, PB.decode(d, String))
        elseif field_number == 3
            num_shards = PB.decode(d, Int64)
        else
            Base.skip(d, wire_type)
        end
    end
    return SimpleShardedDimProto(dim, num_shards)
end

function PB.encode(e::PB.AbstractProtoEncoder, x::SimpleShardedDimProto)
    initpos = position(e.io)
    if isnothing(x.dim);
    elseif x.dim.name === :dim_value
        PB.encode(e, 1, x.dim[]::Int64)
    elseif x.dim.name === :dim_param
        PB.encode(e, 2, x.dim[]::String)
    end
    x.num_shards != zero(Int64) && PB.encode(e, 3, x.num_shards)
    return position(e.io) - initpos
end
function PB._encoded_size(x::SimpleShardedDimProto)
    encoded_size = 0
    if isnothing(x.dim);
    elseif x.dim.name === :dim_value
        encoded_size += PB._encoded_size(x.dim[]::Int64, 1)
    elseif x.dim.name === :dim_param
        encoded_size += PB._encoded_size(x.dim[]::String, 2)
    end
    x.num_shards != zero(Int64) && (encoded_size += PB._encoded_size(x.num_shards, 3))
    return encoded_size
end
...
PB.default_values(::Type{IntIntListEntryProto}) = (;key = zero(Int64), value = Vector{Int64}())
PB.field_numbers(::Type{IntIntListEntryProto}) = (;key = 1, value = 2)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:IntIntListEntryProto})
    key = zero(Int64)
    ...
    return IntIntListEntryProto(key, value[])
end

function PB.encode(e::PB.AbstractProtoEncoder, x::IntIntListEntryProto)
    initpos = position(e.io)
    x.key != zero(Int64) && PB.encode(e, 1, x.key)
    !isempty(x.value) && PB.encode(e, 2, x.value)
    return position(e.io) - initpos
end
function PB._encoded_size(x::IntIntListEntryProto)
    encoded_size = 0
...
@enumx var"TensorProto.DataType" UNDEFINED=0 FLOAT=1 UINT8=2 INT8=3 UINT16=4 INT16=5 INT32=6 INT64=7 STRING=8 BOOL=9 FLOAT16=10 DOUBLE=11 UINT32=12 UINT64=13 COMPLEX64=14 COMPLEX128=15 BFLOAT16=16 FLOAT8E4M3FN=17 FLOAT8E4M3FNUZ=18 FLOAT8E5M2=19 FLOAT8E5M2FNUZ=20 UINT4=21 INT4=22 FLOAT4E2M1=23 FLOAT8E8M0=24
...
struct ShardedDimProto
    axis::Int64
    simple_sharding::Vector{SimpleShardedDimProto}
end
PB.default_values(::Type{ShardedDimProto}) = (;axis = zero(Int64), simple_sharding = Vector{SimpleShardedDimProto}())
PB.field_numbers(::Type{ShardedDimProto}) = (;axis = 1, simple_sharding = 2)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ShardedDimProto})
    axis = zero(Int64)
    simple_sharding = PB.BufferedVector{SimpleShardedDimProto}()
    while !PB.message_done(d)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
            axis = PB.decode(d, Int64)
        elseif field_number == 2
            PB.decode!(d, simple_sharding)
        else
            Base.skip(d, wire_type)
        end
    end
    return ShardedDimProto(axis, simple_sharding[])
end

function PB.encode(e::PB.AbstractProtoEncoder, x::ShardedDimProto)
    initpos = position(e.io)
    x.axis != zero(Int64) && PB.encode(e, 1, x.axis)
    !isempty(x.simple_sharding) && PB.encode(e, 2, x.simple_sharding)
    return position(e.io) - initpos
end
function PB._encoded_size(x::ShardedDimProto)
    encoded_size = 0
    x.axis != zero(Int64) && (encoded_size += PB._encoded_size(x.axis, 1))
    !isempty(x.simple_sharding) && (encoded_size += PB._encoded_size(x.simple_sharding, 2))
    return encoded_size
end
...
struct ShardingSpecProto
    tensor_name::String
    device::Vector{Int64}
    index_to_device_group_map::Vector{IntIntListEntryProto}
    sharded_dim::Vector{ShardedDimProto}
end
PB.default_values(::Type{ShardingSpecProto}) = (;tensor_name = "", device = Vector{Int64}(), index_to_device_group_map = Vector{IntIntListEntryProto}(), sharded_dim = Vector{ShardedDimProto}())
PB.field_numbers(::Type{ShardingSpecProto}) = (;tensor_name = 1, device = 2, index_to_device_group_map = 3, sharded_dim = 4)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ShardingSpecProto})
    tensor_name = ""
    device = PB.BufferedVector{Int64}()
    index_to_device_group_map = PB.BufferedVector{IntIntListEntryProto}()
    sharded_dim = PB.BufferedVector{ShardedDimProto}()
    while !PB.message_done(d)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
            tensor_name = PB.decode(d, String)
        elseif field_number == 2
            PB.decode!(d, wire_type, device)
        elseif field_number == 3
            PB.decode!(d, index_to_device_group_map)
        elseif field_number == 4
            PB.decode!(d, sharded_dim)
        else
            Base.skip(d, wire_type)
        end
    end
    return ShardingSpecProto(tensor_name, device[], index_to_device_group_map[], sharded_dim[])
end

function PB.encode(e::PB.AbstractProtoEncoder, x::ShardingSpecProto)
    initpos = position(e.io)
    !isempty(x.tensor_name) && PB.encode(e, 1, x.tensor_name)
    !isempty(x.device) && PB.encode(e, 2, x.device)
    !isempty(x.index_to_device_group_map) && PB.encode(e, 3, x.index_to_device_group_map)
    !isempty(x.sharded_dim) && PB.encode(e, 4, x.sharded_dim)
    return position(e.io) - initpos
end
function PB._encoded_size(x::ShardingSpecProto)
    encoded_size = 0
    !isempty(x.tensor_name) && (encoded_size += PB._encoded_size(x.tensor_name, 1))
    !isempty(x.device) && (encoded_size += PB._encoded_size(x.device, 2))
    !isempty(x.index_to_device_group_map) && (encoded_size += PB._encoded_size(x.index_to_device_group_map, 3))
    !isempty(x.sharded_dim) && (encoded_size += PB._encoded_size(x.sharded_dim, 4))
    return encoded_size
end
...
struct NodeDeviceConfigurationProto
    ...
    sharding_spec::Vector{ShardingSpecProto}
    pipeline_stage::Int32
end
PB.default_values(::Type{NodeDeviceConfigurationProto}) = (;configuration_id = "", sharding_spec = Vector{ShardingSpecProto}(), pipeline_stage = zero(Int32))
PB.field_numbers(::Type{NodeDeviceConfigurationProto}) = (;configuration_id = 1, sharding_spec = 2, pipeline_stage = 3)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:NodeDeviceConfigurationProto})
    configuration_id = ""
    sharding_spec = PB.BufferedVector{ShardingSpecProto}()
    pipeline_stage = zero(Int32)
    while !PB.message_done(d)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
            configuration_id = PB.decode(d, String)
        elseif field_number == 2
            PB.decode!(d, sharding_spec)
        elseif field_number == 3
            pipeline_stage = PB.decode(d, Int32)
        else
            Base.skip(d, wire_type)
        end
    end
    return NodeDeviceConfigurationProto(configuration_id, sharding_spec[], pipeline_stage)
end

function PB.encode(e::PB.AbstractProtoEncoder, x::NodeDeviceConfigurationProto)
    initpos = position(e.io)
    !isempty(x.configuration_id) && PB.encode(e, 1, x.configuration_id)
    !isempty(x.sharding_spec) && PB.encode(e, 2, x.sharding_spec)
    x.pipeline_stage != zero(Int32) && PB.encode(e, 3, x.pipeline_stage)
    return position(e.io) - initpos
end
function PB._encoded_size(x::NodeDeviceConfigurationProto)
    encoded_size = 0
    !isempty(x.configuration_id) && (encoded_size += PB._encoded_size(x.configuration_id, 1))
    !isempty(x.sharding_spec) && (encoded_size += PB._encoded_size(x.sharding_spec, 2))
    x.pipeline_stage != zero(Int32) && (encoded_size += PB._encoded_size(x.pipeline_stage, 3))
    return encoded_size
end

# Stub definitions for cyclic types
struct var"##Stub#NodeProto"{T1<:var"##Abstract#AttributeProto"} <: var"##Abstract#NodeProto"
    input::Vector{String}
    ...
    doc_string::String
    metadata_props::Vector{StringStringEntryProto}
    device_configurations::Vector{NodeDeviceConfigurationProto}
end

struct var"##Stub#TrainingInfoProto"{T1<:var"##Abstract#GraphProto"} <: var"##Abstract#TrainingInfoProto"
    initialization::Union{Nothing,T1}
    algorithm::Union{Nothing,T1}
    initialization_binding::Vector{StringStringEntryProto}
    update_binding::Vector{StringStringEntryProto}
end

struct var"##Stub#TypeProto.Map"{T1<:var"##Abstract#TypeProto"} <: var"##Abstract#TypeProto.Map"
    key_type::Int32
    value_type::Union{Nothing,T1}
end

struct var"##Stub#TypeProto.Optional"{T1<:var"##Abstract#TypeProto"} <: var"##Abstract#TypeProto.Optional"
    elem_type::Union{Nothing,T1}
end

struct var"##Stub#TypeProto.Sequence"{T1<:var"##Abstract#TypeProto"} <: var"##Abstract#TypeProto.Sequence"
    elem_type::Union{Nothing,T1}
end

struct var"##Stub#ValueInfoProto"{T1<:var"##Abstract#TypeProto"} <: var"##Abstract#ValueInfoProto"
    name::String
    var"#type"::Union{Nothing,T1}
    doc_string::String
    metadata_props::Vector{StringStringEntryProto}
end

struct var"##Stub#AttributeProto"{T1<:var"##Abstract#GraphProto",T2<:var"##Abstract#TypeProto"} <: var"##Abstract#AttributeProto"
    name::String
...
struct var"##Stub#GraphProto"{T1<:var"##Abstract#TypeProto"} <: var"##Abstract#GraphProto"
    node::Vector{var"##Stub#NodeProto"{var"##Stub#AttributeProto"{var"##Stub#GraphProto"{T1},T1}}}
    name::String
    initializer::Vector{TensorProto}
    sparse_initializer::Vector{SparseTensorProto}
    doc_string::String
    input::Vector{var"##Stub#ValueInfoProto"{T1}}
    output::Vector{var"##Stub#ValueInfoProto"{T1}}
    value_info::Vector{var"##Stub#ValueInfoProto"{T1}}
    quantization_annotation::Vector{TensorAnnotation}
    metadata_props::Vector{StringStringEntryProto}
end

struct var"##Stub#FunctionProto"{T1<:var"##Abstract#TypeProto"} <: var"##Abstract#FunctionProto"
    name::String
    input::Vector{String}
    output::Vector{String}
    attribute::Vector{String}
    attribute_proto::Vector{var"##Stub#AttributeProto"{var"##Stub#GraphProto"{T1},T1}}
    node::Vector{var"##Stub#NodeProto"{var"##Stub#AttributeProto"{var"##Stub#GraphProto"{T1},T1}}}
    doc_string::String
...
struct var"##Stub#ModelProto"{T1<:var"##Abstract#TypeProto"} <: var"##Abstract#ModelProto"
    ir_version::Int64
    opset_import::Vector{OperatorSetIdProto}
    ...
    model_version::Int64
    doc_string::String
    graph::Union{Nothing,var"##Stub#GraphProto"{T1}}
    metadata_props::Vector{StringStringEntryProto}
    training_info::Vector{var"##Stub#TrainingInfoProto"{var"##Stub#GraphProto"{T1}}}
    functions::Vector{var"##Stub#FunctionProto"{T1}}
    configuration::Vector{DeviceConfigurationProto}
end

struct var"##Stub#TypeProto" <: var"##Abstract#TypeProto"
    value::Union{Nothing,OneOf{<:Union{var"TypeProto.Tensor",var"##Stub#TypeProto.Sequence"{var"##Stub#TypeProto"},var"##Stub#TypeProto.Map"{var"##Stub#TypeProto"},var"##Stub#TypeProto.Optional"{var"##Stub#TypeProto"},var"TypeProto.SparseTensor"}}}
    denotation::String
end

const NodeProto = var"##Stub#NodeProto"{var"##Stub#AttributeProto"{var"##Stub#GraphProto"{var"##Stub#TypeProto"},var"##Stub#TypeProto"}}
PB.default_values(::Type{NodeProto}) = (;input = Vector{String}(), output = Vector{String}(), name = "", op_type = "", domain = "", overload = "", attribute = Vector{AttributeProto}(), doc_string = "", metadata_props = Vector{StringStringEntryProto}(), device_configurations = Vector{NodeDeviceConfigurationProto}())
PB.field_numbers(::Type{NodeProto}) = (;input = 1, output = 2, name = 3, op_type = 4, domain = 7, overload = 8, attribute = 5, doc_string = 6, metadata_props = 9, device_configurations = 10)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:NodeProto})
    ...
    doc_string = ""
    metadata_props = PB.BufferedVector{StringStringEntryProto}()
    device_configurations = PB.BufferedVector{NodeDeviceConfigurationProto}()
    while !PB.message_done(d)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
            PB.decode!(d, input)
        ...
        elseif field_number == 9
            PB.decode!(d, metadata_props)
        elseif field_number == 10
            PB.decode!(d, device_configurations)
        else
            Base.skip(d, wire_type)
        end
    end
    return NodeProto(input[], output[], name, op_type, domain, overload, attribute[], doc_string, metadata_props[], device_configurations[])
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::NodeProto)
    ...
    !isempty(x.device_configurations) && PB.encode(e, 10, x.device_configurations)
    return position(e.io) - initpos
end
function PB._encoded_size(x::NodeProto)
    ...
    !isempty(x.device_configurations) && (encoded_size += PB._encoded_size(x.device_configurations, 10))
    return encoded_size
end

const TrainingInfoProto = var"##Stub#TrainingInfoProto"{var"##Stub#GraphProto"{var"##Stub#TypeProto"}}
...
const var"TypeProto.Map" = var"##Stub#TypeProto.Map"{var"##Stub#TypeProto"}
...
const var"TypeProto.Optional" = var"##Stub#TypeProto.Optional"{var"##Stub#TypeProto"}
...
const var"TypeProto.Sequence" = var"##Stub#TypeProto.Sequence"{var"##Stub#TypeProto"}
...
const ValueInfoProto = var"##Stub#ValueInfoProto"{var"##Stub#TypeProto"}
...
const AttributeProto = var"##Stub#AttributeProto"{var"##Stub#GraphProto"{var"##Stub#TypeProto"},var"##Stub#TypeProto"}
...
const GraphProto = var"##Stub#GraphProto"{var"##Stub#TypeProto"}
...
const FunctionProto = var"##Stub#FunctionProto"{var"##Stub#TypeProto"}
...
const ModelProto = var"##Stub#ModelProto"{var"##Stub#TypeProto"}
PB.default_values(::Type{ModelProto}) = (;ir_version = zero(Int64), opset_import = Vector{OperatorSetIdProto}(), producer_name = "", producer_version = "", domain = "", model_version = zero(Int64), doc_string = "", graph = nothing, metadata_props = Vector{StringStringEntryProto}(), training_info = Vector{TrainingInfoProto}(), functions = Vector{FunctionProto}(), configuration = Vector{DeviceConfigurationProto}())
PB.field_numbers(::Type{ModelProto}) = (;ir_version = 1, opset_import = 8, producer_name = 2, producer_version = 3, domain = 4, model_version = 5, doc_string = 6, graph = 7, metadata_props = 14, training_info = 20, functions = 25, configuration = 26)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ModelProto})
    ...
    configuration = PB.BufferedVector{DeviceConfigurationProto}()
    while !PB.message_done(d)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
        ...
        elseif field_number == 26
            PB.decode!(d, configuration)
        else
            Base.skip(d, wire_type)
        end
    end
    return ModelProto(ir_version, opset_import[], producer_name, producer_version, domain, model_version, doc_string, graph[], metadata_props[], training_info[], functions[], configuration[])
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::ModelProto)
    ...
    !isempty(x.configuration) && PB.encode(e, 26, x.configuration)
    return position(e.io) - initpos
end
function PB._encoded_size(x::ModelProto)
    ...
    !isempty(x.configuration) && (encoded_size += PB._encoded_size(x.configuration, 26))
    return encoded_size
end

const TypeProto = var"##Stub#TypeProto"
